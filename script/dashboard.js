...
document.getElementById("logoutButton").addEventListener("click", () => {
  const confirmation = confirm("¿Estás segura de que quieres cerrar sesión?");
  if (confirmation) {
...
particlesJS("particles-js", {
  particles: {
    number: {
      value: 20, // Número de partículas (corazones)
      density: {
        enable: true,
        value_area: 800,
      },
...
const mensajes = [
    "Carpe Diem es nuestro Lema 💖",
    "Cada día construimos un futuro distinto, quiero que siempre estés en cada uno de ellos 💖",
    "Eres mi razón de sonreír cada día. 💖",
    "Contigo, cada momento es especial. 🌟",
    "Estoy orgulloso de tus logros, lo perfecta que eres. 🌟",
    "Tu amor es mi mayor tesoro. 🏆",
    "Eres mi hoy, mi mañana y mi siempre. 🌹",
    "Gracias por hacerme tan feliz. 😊",
    "Eres la mejor parte de mi día. ☀️",
    "Mi corazón late por ti. 💓",
    "Te amo mi china preciosa. 💓",
    "Camina mirando hacia el futuro. 💓",
    "Cuando estoy triste, pienso en ti y soporto todo. 💓"
];
